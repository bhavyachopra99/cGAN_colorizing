...
def generate_and_save_images(model, epoch, test_input, output_dir='output_1000', max_images=16):
...
def plot_losses(csv_path, output_dir='output_1000'):
    epochs = []
    gen_losses = []
    disc_losses = []
...
def plot_metrics(csv_path, output_dir='output_1000'):
    epochs = []
    ssim_scores = []
    psnr_scores = []
